    ...
    <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="../horizontal/authentication-error.html"
                        aria-expanded="false">
                        <span class="rounded-3">
                            <i class="ti ti-alert-circle"></i>
                        </span>
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link sidebar-link" href="../horizontal/authentication-maintenance.html"
                        aria-expanded="false">
                        <span class="rounded-3">
